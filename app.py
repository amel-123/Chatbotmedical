...
@app.route('/')
def home():
    # don't clear session here so user can go back/forward if needed;
    # session will be initialized when entering the chatbot.
    return render_template('home.html')

# Route that opens the chatbot and (re)initializes the conversation state
@app.route('/chatbot')
def chatbot_page():
    session.clear()
    session['step'] = 'welcome'
